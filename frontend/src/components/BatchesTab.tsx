  ...
  const handleBatchSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: any = {
        ...
        isNewProduct: isNewProduct, productId: isNewProduct ? null : formData.productId, newProductName: isNewProduct ? formData.newProductName : null, newProductTypeId: isNewProduct ? parseInt(currentTypeId.toString()) : null,
